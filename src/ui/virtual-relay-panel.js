...
.relay-family{display:grid;place-items:center;height:34px;color:#d9fffa;background:#1d6761;border:1px solid #124943;font:600 18px var(--font-mono);letter-spacing:.04em}
...
.relay-health-row{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;padding:8px 10px;border-bottom:1px solid rgba(27,38,41,.18);font:9px var(--font-mono)}.relay-health-row span{display:flex;align-items:center;gap:5px;min-width:0}
...
.relay-led--green{--led-color:#51d77c}.relay-led--amber{--led-color:#f0bc3f}.relay-led--red{--led-color:#ef404e}.relay-led--violet{--led-color:#ae7ff4}.relay-led[data-active="true"]{background:var(--led-color);box-shadow:0 0 9px color-mix(in srgb,var(--led-color) 70%,transparent),inset 0 1px 2px rgba(255,255,255,.72)}.relay-led[data-condition="warning"]{--led-color:#f0bc3f}.relay-led[data-condition="danger"]{--led-color:#ef404e}.relay-led[data-condition="blocked"]{--led-color:#ae7ff4}
...
.relay-face-body{min-height:0;display:grid;grid-template-columns:minmax(0,1fr) 104px;grid-template-rows:auto minmax(0,1fr);gap:10px;padding:7px 10px 9px}.relay-indicator-list{min-width:0;margin:0;padding:0;list-style:none}.relay-indicator-list li{display:grid;grid-template-columns:13px minmax(0,1fr);align-items:center;gap:7px;min-height:34px;padding:6px 7px;border-bottom:1px solid rgba(27,38,41,.18);font:9px var(--font-mono)}.relay-indicator-list .relay-trip-indication{margin-top:6px;border:1px solid rgba(141,28,38,.38);background:rgba(239,64,78,.08);font-weight:700}
